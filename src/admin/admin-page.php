...
<div class="section --dark --sm">
    <div class="container">
        <div class="row">
            <div class="col-md-1" style="width: 24%;">
                <div class="panel">
                    ...
                    <div class="panel__body">
                        ...
                        while ($tools->fetch()) {
                            echo "<li class='item list-group-item' data-title='$name' data-id='$id_tools' >$name<span class='right contain_tools'>
                                    <!--<a class='edit_tool' href='#' ><span class='glyphicon glyphicon-wrench'></span></a>-->
            ...
            <form class="cmxform" id="commentForm" method="POST" action="" >
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name-tool" id="name-tool" required value="jackie">
                    </div>
                    <div class="form-group">
                        <label for="info-tool" class="control-label">Information:</label>
                        <textarea class="form-control" name="info-tool" id="info-tool" required>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes</textarea>
                    </div>
                    <div class="form-group">
                        <label for="url-tool" class="control-label">Website:</label>
                        <input type="url" class="form-control" name="url-tool" id="url-tool" required value="http://www.google.co.th/">
                    </div>

                    <div class="form-group">
                        <label for="img-tool" class="control-label">Tools Image URL:</label>
                        <input type="url" class="form-control" name="img-tool" id="img-tool" required value="http://corsairmediaservices.com/images/blog/tools.jpg">
                    </div>
...
//                        $('.btn-close').click();
        ...
        /*
         $(document).on('click','.right.contain_tools a.edit_tool',function () {
         var confirmmssg = confirm('Doyou want to edit this ?');
         if (confirmmssg) {
         id = $(this).attr('data-id');
         //  alert(id);
         $.ajax({
